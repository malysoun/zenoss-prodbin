...
# 
##############################################################################
from Products.ZenRelations.RDBMSRelationshipBase import relDbTransactional, getSqlCursor
...
from RelationshipBase import RelationshipBase, IRelationship
...
class RDBMSToOneRelationship(RelationshipBase):
    ...
    def exportXml(self, ofile, ignorerels=[]):
        ...
        obj = self()
        if not obj or self.remoteType() == ToManyCont: return
...
InitializeClass(RDBMSToOneRelationship)
